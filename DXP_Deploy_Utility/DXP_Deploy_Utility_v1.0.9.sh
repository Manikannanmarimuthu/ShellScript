...
status_check
 ...
 print_head "Procceding to remove the http.properites /hlfapp/DXPApp/online/mdynamics/bin/http.properties "
if ![ "$environment" = "vit" ]; then
    cd /hlfapp/DXPApp/online/mdynamics/bin; 
    rm -rf http.properties;
