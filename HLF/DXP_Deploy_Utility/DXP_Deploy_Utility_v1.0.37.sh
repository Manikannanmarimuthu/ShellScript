...
if [ "$environment" = "uat" ]; then
  print_info "Adding NewRelic APM (auth, datasync, batch, inquiry)"
export JAVA_OPTS="$JAVA_OPTS -javaagent:/opt/newrelic-dxp-inquiry/newrelic.jar -Dnewrelic.environment=uat"
  print_info "Adding NewRelic APM (online-app)"
JVM_OPTION="$JVM_OPTION -javaagent:/opt/newrelic-dxp-online-app/newrelic.jar -Dnewrelic.environment=uat"
  print_info "Adding NewRelic APM (online-wsapp)"
JVM_OPTION="$JVM_OPTION -javaagent:/opt/newrelic-dxp-online-wsapp/newrelic.jar -Dnewrelic.environment=uat"
else
